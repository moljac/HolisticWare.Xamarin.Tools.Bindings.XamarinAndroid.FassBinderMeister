...
namespace HolisticWare.Xamarin.Tools.Maven.DependencyObjectModel
{
	...
	[
		...
		(
			typeof(HolisticWare.Xamarin.Tools.Maven.ProjectObjectModel.Serialization.Formatters.Dependency)
		)
	]
