...
namespace HolisticWare.Xamarin.Tools.Maven.DeveloperObjectModel
{
	...
	[
		...
		(
			typeof(HolisticWare.Xamarin.Tools.Maven.ProjectObjectModel.Serialization.Formatters.Developer)
		)
	]
