...
namespace HolisticWare.Xamarin.Tools.Maven.LicenseObjectModel
{
	...
	[
		...
		(
			typeof(HolisticWare.Xamarin.Tools.Maven.ProjectObjectModel.Serialization.Formatters.License)
		)
	]
