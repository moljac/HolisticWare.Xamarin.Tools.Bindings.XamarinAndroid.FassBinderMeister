...
namespace HolisticWare.Xamarin.Tools.Maven.LicensesObjectModel
{
	...
	[
		...
		(
			typeof(HolisticWare.Xamarin.Tools.Maven.ProjectObjectModel.Serialization.Formatters.Licenses)
		)
	]
