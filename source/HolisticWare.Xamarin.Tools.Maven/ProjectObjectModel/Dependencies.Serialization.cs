...
namespace HolisticWare.Xamarin.Tools.Maven.DependenciesObjectModel
{
	...
	[
		...
		(
			typeof(HolisticWare.Xamarin.Tools.Maven.ProjectObjectModel.Serialization.Formatters.Dependencies)
		)
	]
