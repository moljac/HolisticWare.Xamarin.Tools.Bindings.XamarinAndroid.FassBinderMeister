...
namespace HolisticWare.Xamarin.Tools.Maven.Repositories.MavenCentralSonatype
{
    ...
    {
        static ArtifactUnversioned()
        {
            UrlMavenMetadataDefault = new Uri($"{Repository.UrlRootDefault}/_PLACEHOLDER_GROUP_ID_/_PLACEHOLDER_ARTIFACT_ID/maven-metadata.xml");
        ...
        public POM.ProjectObjectModel ProjectObjectModel
        {
            get;
            set;
        }
        ...
        public async
            Task<ArtifactMetadata.Metadata>
                            GetMavenMetadataAsync
                                        (
                                        )
        {
            ArtifactMetadata.Metadata result = null;
