    ...
    public partial class NuGetPackage
    {
        public static partial class Utilities
        {
                                            ...
                                            )
            {
                ...
                Versions data = SpanJson.JsonSerializer.Generic.Utf8
                                                                .Deserialize<Versions>(response);
                                            ...
                                            )
            {
                ...
                try
                {
                    data = SpanJson.JsonSerializer.Generic.Utf8
                                                            .Deserialize<PackageRegistration>(response);
                }
                catch (Exception e)
                {
                    Console.WriteLine(e);
